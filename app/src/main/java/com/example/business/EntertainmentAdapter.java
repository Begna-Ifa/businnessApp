...
public class EntertainmentAdapter extends BaseAdapter {
    ...
    private List<EntertainmentItem> mEntertainmentList;
    private boolean isFavorite = false;

    public EntertainmentAdapter(Context context, List<EntertainmentItem> entertainmentList) {
        mContext = context;
    ...
    public Object getItem(int position) {
        return mEntertainmentList.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        EntertainmentItem currentItem = (EntertainmentItem) getItem(position);
