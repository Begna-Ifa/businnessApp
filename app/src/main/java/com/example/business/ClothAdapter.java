...
public class ClothAdapter extends BaseAdapter {
    ...
    private List<ClothItem> mClothList;
    private boolean isFavorite = false;

    public ClothAdapter(Context context, List<ClothItem> clothList) {
        mContext = context;
    ...
    public Object getItem(int position) {
        return mClothList.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ClothItem currentItem = (ClothItem) getItem(position);
